...
readonly ZAGHI_LIBRARIES=("BeFoR64" "PENF")  #StringiFor is not supported updating because the lastest commit has an intel complier's problem.

# INTERNAL VARIABLES AND INITIALIZATIONS
readonly DOWNLOADS="downloads"
readonly SRC="src"
readonly ZAGHI="https://git.oschina.net/ltlx_at_tju"
function clone () {
   # clone repository
